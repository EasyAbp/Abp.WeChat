...
namespace EasyAbp.Abp.WeChat.Pay.Services.Pay
{
    ...
    /// 集成了普通商户的微信支付 API 接口。
    /// </summary>
    public class OrdinaryMerchantPayWeService : WeChatPayServiceBase
    {
        public OrdinaryMerchantPayWeService(AbpWeChatPayOptions options, IAbpLazyServiceProvider lazyServiceProvider) : base(options, lazyServiceProvider)
        {
        }
        ...
        public virtual async Task<XmlDocument> UnifiedOrderAsync(string appId, string mchId, string deviceInfo,
            ...
            string tradeType, string productId, string limitPay, string openId, string receipt, string sceneInfo, bool isProfitSharing = false)
        {
        ...
        /// <param name="openId">当 <paramref name="tradeType"/> 参数为 <see cref="TradeType.JsApi"/> 时，此参数必填。</param>
        /// <param name="isProfitSharing">该笔订单是否参与分账操作。</param>
        public virtual async Task<XmlDocument> UnifiedOrderAsync(string appId, string mchId, string body, string attach,
            string outTradeNo, int totalFee, string tradeType, string openId, bool isProfitSharing = false)
        {
        ...
        public virtual async Task<XmlDocument> RefundAsync(string appId, string mchId, string orderNo,
            string refundOrderNo, int orderTotalFee, int refundFee, string refundDescription = null)
        {
            var request = new WeChatPayParameters();
            request.AddParameter("appid", appId);
            request.AddParameter("mch_id", mchId);
        ...
        public virtual async Task<XmlDocument> OrderQueryAsync(string appId, string mchId, string weChatOrderNo = null,
            string orderNo = null)
        {
