...
namespace EasyAbp.Abp.WeChat.Official.Services.User
{
    ...
    /// 黑名单管理服务，管理公众号的黑名单。
    /// </summary>
    public class BlackListWeService : OfficialAbpWeChatServiceBase
    {
        ...
        public BlackListWeService(AbpWeChatOfficialOptions options, IAbpLazyServiceProvider lazyServiceProvider) : base(options, lazyServiceProvider)
        {
        }
