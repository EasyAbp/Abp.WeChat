...
namespace EasyAbp.Abp.WeChat.Official.Services.TemplateMessage
{
    ...
    public class TemplateMessage : Dictionary<string, TemplateMessageItem>
    {
        ...
        [Obsolete("微信已停用first/remark和自定义文本颜色：https://mp.weixin.qq.com/cgi-bin/announce?action=getannouncement&announce_id=11680142498cInTZ&version=&lang=zh_CN&token=")]
