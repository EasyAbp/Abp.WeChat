...
using Shouldly;
using Xunit;
using Zony.Abp.WeiXin.Official.Services.TemplateMessage;

namespace Zony.Abp.WeiXin.Official.Tests.Services
{
    public class TemplateMessageService_Tests : AbpWeiXinOfficialTestBase
    {
